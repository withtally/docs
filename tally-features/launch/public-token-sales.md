---
description: Launch branded token sales with custom interfaces
icon: sack-dollar
---
...
* **Protocol-agnostic integration**: Support for [Balancer LBPs](https://docs.balancer.fi/concepts/explore-available-balancer-pools/liquidity-bootstrapping-pool.html) and custom sale contracts
...
### Case study: Hyperwave's token sale
