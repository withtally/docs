...
{% content-ref url="optimistic-governance.md" %}
[optimistic-governance.md](optimistic-governance.md)
{% endcontent-ref %}

{% content-ref url="security-council-elections/" %}
[security-council-elections](security-council-elections/)
{% endcontent-ref %}

{% content-ref url="multigov.md" %}
