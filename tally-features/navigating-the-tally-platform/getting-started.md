...
Now you can update your Safe's profile and make onchain transactions. To learn more about making onchain transactions using your Safe, see [use-tally-with-a-gnosis-safe](../../how-to-use-tally/use-tally-with-a-gnosis-safe/ "mention").
